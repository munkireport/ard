<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="ard_directory_login-widget">
        <div id="ard_directory_login-widget" class="panel-heading" data-container="body">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/ard/get_directory_login', function( data ) {
        ...
        var panel = $('#ard_directory_login-widget div.panel-body'),
